...
export class ElectronChromeExtensions extends EventEmitter {
  ...
  constructor(opts: ChromeExtensionOptions) {
    ...
    // Create BrowserActionAPI first so it can be passed to SidePanelAPI
    const browserActionAPI = new BrowserActionAPI(this.ctx)
    ...
    this.api = {
      ...
      sidePanel: new SidePanelAPI(this.ctx, browserActionAPI),
    }
